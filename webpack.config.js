    ...
    plugins: [
      ...
      new WebpackShellPlugin({
        ...
        onBuildEnd:[
          ...
          mode == 'development' ? 'echo Skipping JS stub generation' : 'for /r "CTFd\themes\core\static\js" %i in (*.dev.js) do if not exist "%~dpni.min.js" type nul > "%~dpni.min.js" \n for /r "CTFd\themes\admin\static\js" %i in (*.dev.js) do if not exist "%~dpni.min.js" type nul > "%~dpni.min.js"'
